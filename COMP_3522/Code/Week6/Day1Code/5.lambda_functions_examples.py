...
def main():
    ...
    print(f"The result of filter when converted to a string: " f"{list(consonants)}")
    ...
    print(
        f"Attempting to print the result of the filter() function: "
        f"{list(consonants)}"
    )
    ...
    print(
        f"Result of map function to pull out the first names from a list of "
    ...
    print(
        f"Attempting to print the result of the map() function: "
    ...
    print(f"Result of using maps with multiple arguments: " f"{tuple(full_names_map)}")
