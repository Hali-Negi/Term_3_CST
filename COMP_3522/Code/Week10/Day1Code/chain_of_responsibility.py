...
class EnrolmentApplicationForm:
    ...
    def __init__(
        ...
        age: int,
        student_id: str,
        courses_for_enrolment: list,
        student_account: StudentAccount,
        enrolment_fees_paid: bool,
        school_year: int,
    ):
        """
...
class ValidateStudentHandler(BaseSchoolFormHandler):
    ...
    def handle_form(self, form: EnrolmentApplicationForm) -> (str, bool):
        ...
        if (
            form.name == form.student_account.student_name
            and form.student_id == form.student_account.student_id
        ):
...
class EnrolmentSystem:
    ...
    def enrol(
        self, form: EnrolmentApplicationForm, skip_course_validation: bool = False
    ) -> bool:
        """
...
def main():
    ...
    enrolment_form = EnrolmentApplicationForm(
        "Zorak",
        25,
        "A02355232",
        [
    ...
    enrolment_system.enrol(enrolment_form, False)
