...
class Team:
    ...
    def __init__(self, team_name="Team Ninja", team_members=[]):
        """
        INCORRECT - Initializes a team with the given name and members, or default
        values if not provided. Single default [] exists
        :param team_name: a string
        :param team_members: a list
        """
        team_members.append('Person') #person added to default [] everytime __init__ invoked
        self.name = team_name
        self.members = team_members

    # def __init__(self, team_name="Team Ninja", team_members=None):
    #     """
    #     CORRECT - Initializes a team with the given name and members, or default
