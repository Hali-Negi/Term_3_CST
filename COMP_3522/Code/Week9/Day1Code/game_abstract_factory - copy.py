...
class World:
    """
    Defines a world that consists of Friendlies, Enemies and Animals.
    Each world has a theme/variety.
    """

    # def __init__(self, char_factory: CharacterFactory):
    def __init__(self, acquaticaCharFactory, firelandsCharFactory):
        """
        ...
        self.aquaticaCharFactory = acquaticaCharFactory
        self.firelandsCharFactory = firelandsCharFactory
        ...
        self.friendlies.append(self.aquaticaCharFactory.create_friendly())
        self.friendlies.append(self.firelandsCharFactory.create_friendly())
        self.enemies.append(self.aquaticaCharFactory.create_enemy())
        self.enemies.append(self.firelandsCharFactory.create_enemy())
        self.animals.append(self.aquaticaCharFactory.create_animal())
        self.animals.append(self.firelandsCharFactory.create_animal())
    ...
    def simulate(self):
        ...
        for enemy in self.enemies:
            print(f"{enemy.name} tried to defend! Success: " f"{enemy.defend()}")
...
def main():
    # choice = int(input("Enter the world to create. 1 - Aquatic World, 2 - Fire World"))
    # factory = AquaticaCharacterFactory() if choice == 1 else FirelandsCharacterFactory()
    aquaticCharacterFactory = AquaticaCharacterFactory()
    firelandCharacterFactory = FirelandsCharacterFactory()

    # world = World(factory)
    world = World(aquaticCharacterFactory, firelandCharacterFactory)
    world.simulate()
