...
use Dictionary Comprehensions to iterate over all the bidders, and create a dictionary where each bidder is the key and their highest bid is the associated value. Print out a summary where each bidder\'s name and their highest bid is displayed.
