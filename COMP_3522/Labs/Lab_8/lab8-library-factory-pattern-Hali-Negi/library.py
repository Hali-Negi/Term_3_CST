...
# Just method names updated to match catalogue.py
from catalogue import Catalogue
...
class Library:
    """
    Represents the library system.
    Delegates all operations to the Catalogue.
    """
    ...
    def find_items(self, string):
        return self.catalogue.find_items(string)
    ...
    def add_item_from_factory(self, factory):
        """
        Uses the provided factory to create and add an item.
        """
        self.catalogue.add_item_from_factory(factory)