...
# Journal inherits from LibraryItem, so:
# title, call_number, num_of_copies → already handled by parent via
# super().__init__()
# check_availability → already handled by parent
# Journal only needs to define what's unique to it: author, issue_number, publisher
# The child class doesn't repeat what the parent already does
