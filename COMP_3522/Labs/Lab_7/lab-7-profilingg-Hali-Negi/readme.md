...
Clarification - **unique** can be interpreted in multiple ways. So I'm accepting interpreting unique as "The only time a word appears in the text" and "the different words that appear in the text"
...
2. Go through the [Slides](slides.pptx) to learn how to optimize python code.
